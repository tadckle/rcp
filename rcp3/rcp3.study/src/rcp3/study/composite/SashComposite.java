...
public class SashComposite extends Composite {
  ...
  public static class HideStyle {
     ...
     * @param width
     *          indicate the width of hide composite.
     * @param showByDefault
     *          true means show hide composite at first open.
     */
   ...
   * @param hideDirection
   *          where the hide part stays. Candidate value are SWT.LEFT, SWT.RIGHT,
   *          SWT.TOP and SWT.BOTTOM.
   * @param hideWidth
   *          the width of hide composite.
   */
  ...
  private GridData createHideCompGd() {
    Point hint = hideStyle.isHorizontal() ? new Point(hideStyle.width, SWT.DEFAULT)
        : new Point(SWT.DEFAULT, hideStyle.width);
    boolean xGrab = true;
    boolean yGrab = true;
