...
/**
 * This label can be directly put in any SWT control. The second parameter
 * specifies text direction. Available directions are:
 * DirectionLabel.LEFT_TO_RIGHT , DirectionLabel.TOP_TO_BOTTOW and
 * DirectionLabel.TOP_TO_BOTTOW.
 * 
 * @author Alex
 */
